                ...
                <AccordionItem key={meso._id} value={meso._id}>
                    <AccordionTrigger className="cursor-pointer">
                        ...
                        >
                            ...
                            {user?.activeMesocycle?.mesocycle._id === meso._id && <span className='mr-auto text-green-500 font-bold ml-2'>ACTIVE</span>}
                        </div>
                    </AccordionTrigger>
                    <AccordionContent>
                        ...
                        {user?.activeMesocycle?.mesocycle._id !== meso._id && <Button

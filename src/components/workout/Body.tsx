...
export default function Body({muscleGroups}: BodyProps) {
    ...
    useEffect(() => {
        muscleGroups.forEach(group => {
            const pathsFront = svgFrontRef.current?.querySelectorAll(`#${group.muscle} path`);
            const pathsBack = svgBackRef.current?.querySelectorAll(`#${group.muscle} path`);

            pathsFront?.forEach(path => {
                path.setAttribute('fill', highlightColors[Math.min(group.intensity, highlightColors.length - 1)]);
                path.setAttribute('stroke', 'none')
            });
            pathsBack?.forEach(path => {
                path.setAttribute('fill', highlightColors[Math.min(group.intensity, highlightColors.length - 1)]);
                path.setAttribute('stroke', 'none')
            });
        });
                ...
                <g id="Frame 2" clip-path="url(#clip0_1_111)">
                    ...
                    <g id="neck">
                        ...
                        <path id="neck_3"
                              ...
                              strokeMiterlimit={strokeMiterlimit}
                        />
                        <path id="neck_4" d="M315.5 91.5L316.5 39H310.5L308.5 57.5L309.5 88.5V97.5V106L315.5 91.5Z"
                              stroke={strokeColor}
                              strokeWidth={strokeWidth}
                              strokeLinecap={strokeLinecap}
                              strokeLinejoin={strokeLinejoin}
                        ...
                        <path id="neck_6"
                              ...
                              strokeMiterlimit={strokeMiterlimit}
                        />
                        <path id="neck_7" d="M293.5 91.5L292.5 39H298.5L300.5 57.5L299.5 88.5V97.5V106L293.5 91.5Z"
                              stroke={strokeColor}
                              strokeWidth={strokeWidth}
                              strokeLinecap={strokeLinecap}
                              strokeLinejoin={strokeLinejoin}
                    ...
                    <g id="forearms">
                        <g id="forearms_2">
                            <path
                                ...
                                strokeMiterlimit={strokeMiterlimit}
                            />
                            <path d="M541 369L537 349.5L520 343L515.5 347.5L541 369Z" stroke={strokeColor}
                                  strokeWidth={strokeWidth}
                                  strokeLinecap={strokeLinecap}
                                  strokeLinejoin={strokeLinejoin}
                                  strokeMiterlimit={strokeMiterlimit}
                        ...
                        <g id="forearms_3">
                            <path
                                ...
                                strokeMiterlimit={strokeMiterlimit}
                            />
                            <path d="M68 369L72 349.5L89 343L93.5 347.5L68 369Z" stroke={strokeColor}
                                  strokeWidth={strokeWidth}
                                  strokeLinecap={strokeLinecap}
                                  strokeLinejoin={strokeLinejoin}
                                  strokeMiterlimit={strokeMiterlimit}
                            ...
                            <path
                                ...
                                strokeMiterlimit={strokeMiterlimit}
                            />
                            <path d="M94.5 421L112.5 370L108.5 364.5L77 424L49 467L23.5 504L27 507L51.5 472.5L94.5 421Z"
                                  stroke={strokeColor}
                                  strokeWidth={strokeWidth}
                                  strokeLinecap={strokeLinecap}
                                  strokeLinejoin={strokeLinejoin}
                    ...
                    <g id="triceps">
                        <g id="triceps_2">
                            <path
                                ...
                                stroke="black"/>
                            <path d="M161 223L113.5 263.5L110.5 259L103 263.5L135 182L142.5 185.5L155 192V208L161 223Z"
                                  stroke="black"/>
                            <path
